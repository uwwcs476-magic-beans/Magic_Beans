...
public final class setupWizardIterator implements WizardDescriptor.Iterator<WizardDescriptor> {
    ...
    private List<WizardDescriptor.Panel<WizardDescriptor>> getPanels() {
        if (panels == null) {
            ...
            panels.add(new setupWizardPanel1());
            panels.add(new setupWizardPanel2());
